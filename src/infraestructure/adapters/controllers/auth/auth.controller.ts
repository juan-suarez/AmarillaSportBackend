import { Body, Controller, Delete, Post, Res, UsePipes, ValidationPipe } from '@nestjs/common';
...
export class AuthController {
    ...
    async Login(@Body() loginPayload:LoginDto, @Res( {passthrough: true }) response: Response){
    ...
    LogOut(@Res( {passthrough: true }) response: Response){
        ...
        response.clearCookie("accessToken").send({message:"log out successfully"})
    }
